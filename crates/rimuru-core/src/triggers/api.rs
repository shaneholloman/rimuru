...
const ROUTES: &[Route] = &[
    ...
    Route { method: "POST", path: "api/plugins/:id/enable", function_id: "rimuru.plugins.start" },
    Route { method: "POST", path: "api/plugins/:id/disable", function_id: "rimuru.plugins.stop" },
